...
<html data-theme='default'>
 <head>
  ...
  <link as='image' href='{TEMPLATE_IMAGE}' rel='preload'>
  ...
  <meta content='{BRAND} merupakan salah satu situs referensi terbaik untuk anda yang ingin bermain provider Pragmatic Play resmi 2026 untuk memenuhi kebutuhan para pemain slot online dengan ramah setiap hari.'>
  ...
  <meta name="keywords" content="{BRAND}, slot gacor, slot, slot gacor 2026"/>
  ...
  <script>
   dataLayer.push({
    ...
    "design__variant": "{\"Gender\":\"Male Fit\",\"Style\":\"Classic SITUS {BRAND}\",\"Color\":\"Red\"}",
    "design__mock_image": "{TEMPLATE_IMAGE}",
    "design__url": "{CANONICAL}",
    "design__canvas": "SITUS {BRAND}",
    "design__canvas_canonical_name": "SITUS {BRAND}",
    "design__design_title": "{BRAND} merupakan salah satu situs referensi terbaik untuk anda yang ingin bermain provider Pragmatic Play resmi 2026 untuk memenuhi kebutuhan para pemain slot online dengan ramah setiap hari.",
    "design__price": 23.0,
    ...
    "ecommerce": {
     "detail": {
      "products": [{
       ...
       "design_primary_tag": "SLOT GACOR 2026",
       "design_on_sale": "false",
       "variant": '{"Gender":"Male Fit","Style":"SITUS {BRAND}","Color":"Red"}',
       "dimension34": '74165272D1V19G79A8C',
       "dimension37": 'false',
       "dimension42": '{TEMPLATE_IMAGE}',
...
<![endif]-->
 ...
 <body class='no-user' data-action='lazyload@window-&gt;checkout--checkout#initCheckout' data-controller='checkout--checkout utilities--ab-test utilities--timer' data-utilities--timer-containers--countdown-outlet='.containers--countdown' id='teepublic'>
  ...
  <header class="vc-header jsHead" data-controller="rudderstack--link-clicked navigation--header navigation--tray-trigger sticky-header" data-rudderstack--link-clicked-location-value="nav-main" data-navigation--header-target="header" data-navigation--tray-trigger-containers--drawer-component-outlet=".jsHeaderTray" data-navigation--tray-trigger-navigation--cart-outlet=".jsCartTray" data-action="showElement@document-&gt;sticky-header#showHeader" data-sticky-header-containers--banner-outlet=".containers--banner" data-sticky-header-rendering-rails-ctrl-value="product_pages">
   ...
   <div class="vc-header-logo">
    <a aria-label="Home Link" title="Home" href="{CANONICAL}" class="link vc-header-logo__wrapper link--1 link--default">
     <span class='link__content'>
      <div class="header-mini__logo" bis_skin_checked="1">
       <a href="{CANONICAL}">
        <img alt="SITUS {BRAND}" src="{LOGO_BRAND}" style="height:100px; width:300px; display:">
       </a>
      </div>
     </span>
    </a>
   ...
   <div class='vc-header__search-container'>
    <div class='m-header__search m-header__search--animate jsHeadSearch inactive' data-navigation--header-target='searchFieldWrapper' data-sticky-header-target='searchRow'>
     <form id="search_form" class="jsHeadSearchForm gtmSearchHeader input-group" action="{CANONICAL}" accept-charset="UTF-8" method="post">
      ...
      <div class='m-header__search-field-container'>
       <div class='m-header__search-field-placeholder-wrapper' data-navigation--header-target='placeholderWrapper'>
        <div class='m-header__search-field-placeholder'>
         <p>Cari kami di Google : {BRAND}
         <p>Daftar Referensi Situs PG Soft Game Online Terbaik Resmi Hari Ini {BRAND}
       ...
       <input type="hidden" name="canvas" id="canvas" value="SITUS {BRAND}" autocomplete="off" />
    ...
    <div class='m-tab-nav__content'>
     <div class="m-tab-nav__tab-content" data-utilities--tab-target="content" data-tab-content-index="0">
      <div class='m-explore-nav__tab-content'>
       ...
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Lebaran" data-href="{CANONICAL}" title="Lebaran SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>{BRAND}</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Music" data-href="{CANONICAL}" title="Music SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>SITUS {BRAND}</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Sports" data-href="{CANONICAL}" title="Sport SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>SLOT GACOR</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Movies" data-href="{CANONICAL}" title="Movie SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>SLOT GACOR 2026</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Vintage" data-href="{CANONICAL}" title="Vintage SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>{BRAND} SLOT</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Animals" data-href="{CANONICAL}" title="Animal SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>SITUS SLOT GACOR</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Television" data-href="{CANONICAL}" title="Television SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>{BRAND} DAFTAR</span>
       </a>
       <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Funny" data-href="{CANONICAL}" title="Funny SITUS {BRAND}" href="{CANONICAL}" class="link m-explore-nav__link link--1 link--default tp-btn--icon">
        <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
         <img src="{FAVICON}" loading="auto" height="40" width="40" aria_hidden="true" focusable="false">
        </span>
        <span class='link__content'>{BRAND} RESMI</span>
       </a>
      </div>
     </div>
     </a>
    ...
    <div class="col-12">
     <div class="w-100 mt-4 mb-4 text-center">
      <div class="n-columns-2">
       <a href="{AMP}" rel="nofollow noreferrer" class="login">LOGIN</a>
       <a href="{AMP}" rel="nofollow noreferrer" class="register">DAFTAR</a>
      </div>
     </div>
    </div>
    </section>
      ...
      <script type="application/ld+json">
 {
  ...
  "image": [{
   ...
   "@context": "https://schema.org",
   "author": "{BRAND}",
   "contentURL": "{TEMPLATE_IMAGE}",
   "description": "{BRAND} merupakan salah satu situs referensi terbaik untuk anda yang ingin bermain provider Pragmatic Play resmi 2026 untuk memenuhi kebutuhan para pemain slot online dengan ramah setiap hari.",
   "thumbnail": "{TEMPLATE_IMAGE}"
  }],
  "category": "{BRAND} > SITUS {BRAND} > SLOT GACOR 2026",
  "brand": {
   "@type": "Brand",
   "@context": "https://schema.org",
   "name": "{BRAND}"
  ...
  "review": [{
   ...
   "reviewBody": "{BRAND} benar-benar membuat login dan manajemen akun Clerk YouDown jadi lebih mudah. Fitur unggulannya cepat, aman, dan tampilan modern membuat saya nyaman setiap kali menggunakan platform ini.",
   "author": {
    "@type": "Person",
    "name": "Mas Mueng"
   }
   ...
   "reviewBody": "Sejak pakai Link Alternatif {BRAND}, saya bisa langsung mengelola akun digital dengan mudah tanpa ribet. Semua data akurat dan update real-time, sangat membantu untuk kebutuhan profesional saya.",
   "author": {
    "@type": "Person",
    "name": "Johan"
   }
   ...
   "reviewBody": "{BRAND} sangat ramah untuk pemula. Bahkan tanpa pengalaman teknis, saya bisa login dan mengelola akun YouDown dengan lancar. Ini platform unggulan yang patut dicoba!",
   "author": {
    "@type": "Person",
    "name": "Hasiholan"
   }
   ...
   "datePublished": "2025-01-20",
   "reviewBody": "Keamanan {BRAND} benar-benar terasa. Setiap login dan aktivitas manajemen akun terlindungi, sehingga saya bisa fokus bekerja tanpa khawatir.",
   "author": {
    "@type": "Person",
    "name": "Vermalion"
   }
   ...
   "datePublished": "2025-01-20",
   "reviewBody": "Platform {BRAND} cepat dan stabil. Semua fitur unggulan berjalan mulus dan membantu saya dalam mengelola akun digital setiap hari.",
   "author": {
    "@type": "Person",
    "name": "Farhan"
   }
   ...
   "reviewBody": "{BRAND} adalah solusi modern untuk login dan manajemen akun Clerk YouDown. Data selalu update real-time, tampilan user-friendly, dan terpercaya.",
   "author": {
    "@type": "Person",
    "name": "Cipung"
   }
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Apa itu Link Alternatif {BRAND}?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Link Alternatif {BRAND} adalah akses resmi untuk login dan manajemen akun Clerk YouDown dengan sistem modern, cepat, dan aman."
      }
    },
    {
      "@type": "Question",
      "name": "Apa keunggulan {BRAND} dibanding platform lain?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "{BRAND} menawarkan keamanan data, kecepatan akses, serta fitur manajemen akun unggulan yang mudah digunakan."
      }
    },
    {
      "@type": "Question",
      "name": "Apakah {BRAND} aman digunakan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ya, {BRAND} menggunakan sistem modern dari YouDown untuk memastikan setiap aktivitas login dan manajemen akun aman."
      }
    },
    {
      "@type": "Question",
      "name": "Apakah {BRAND} cocok untuk pemula?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sangat cocok, karena tampilan {BRAND} sederhana dan mudah dipahami sehingga pemula pun bisa langsung mengelola akun mereka."
      }
    },
    {
      "@type": "Question",
      "name": "Bagaimana cara mengakses Link Alternatif {BRAND}?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Cukup gunakan link resmi {BRAND} untuk langsung login ke Clerk YouDown dan mulai mengelola akun digital Anda dengan mudah."
      }
    }
  ]
}
        ...
        <div class='m-design__content'>
         <div class='m-design__product' data-controller='rudderstack--link-clicked' data-rudderstack--link-clicked-location-value='pdp'>
          <div class='m-design-details__title'>
           <h1 class='h__h1--sm h--no-s-b' title='George Kittle F Dallas Kittle - George Kittle - SITUS {BRAND}'>{BRAND} # Daftar Referensi Situs PG Soft Game Online Terbaik Resmi Hari Ini</h1>
            ...
            <div class='m-product-preview__main jsProductMainImages'>
             <div class='m-product-preview__gallery'>
                ...
                <ul class='glide__slides'>
                 <li class='glide__slide m-product-preview__glider-slide' data-default='active' data-id='0' data-label=''>
                  <picture class='m-product-preview__glider-img'>
                   <img alt='{BRAND} # Daftar Referensi Situs PG Soft Game Online Terbaik Resmi Hari Ini by Hey siriusly' class='mockup jsProductMainImage' src='{TEMPLATE_IMAGE}'>
                  </picture>
                 </li>
                 <li class='glide__slide m-product-preview__glider-slide' data-default='' data-id='1' data-label=''>
                  <picture class='m-product-preview__glider-img'>
                   <img alt='George Kittle F Dallas Kittle by Hey siriusly' class='preview jsProductMainImage' src='{TEMPLATE_IMAGE}'>
                  </picture>
                 </li>
                </ul>
               </div>
              ...
              <div class='m-product-preview__thumbs jsProductPreviewThumbs jsProductImgGlideCtrls' data-glide-el='controls'>
               <a data-id="0" href="{CANONICAL}" class="link m-product-preview__thumb jsProductPreviewThumb jsCtrl on">
                <span class='link__content'>
                 <picture data-action='click-&gt;rudderstack--filter-clicked#track' data-cart-id='9a8c68d58aaa0c110ea9655af8a790a4' data-filter-name='thumbnail' data-glide-dir='0'>
                  <img alt='{BRAND} # Daftar Referensi Situs PG Soft Game Online Terbaik Resmi Hari Ini by Hey siriusly' class='mockup' loading='lazy' src='{TEMPLATE_IMAGE}'>
                 </picture>
                </span>
               </a>
               <a data-id="1" href="{CANONICAL}" class="link m-product-preview__thumb jsProductPreviewThumb jsCtrl">
                <span class='link__content'>
                 <picture data-action='click-&gt;rudderstack--filter-clicked#track' data-cart-id='9a8c68d58aaa0c110ea9655af8a790a4' data-filter-name='thumbnail' data-glide-dir='1'>
                  <img alt='George Kittle F Dallas Kittle by Hey siriusly' class='preview' loading='lazy' src='{TEMPLATE_IMAGE}'>
                 </picture>
                </span>
               </a>
              </div>
...
<div class="info-box-kaisar">
    <div class="info-header-kaisar">
        INFORMASI LENGKAP {BRAND}
    </div>
    
    <div class="info-row-kaisar">
        <span class="info-label-kaisar">Nama Situs</span>
        <span class="info-value-kaisar"><strong>{BRAND}</strong></span>
    </div>
...
.faq-section::before {
    ...
    width: 100%;
    height: 4px;
    background: linear-gradient(90deg, #ff0000, #9c27b0, #ff0000);
...
.faq-item::before {
    ...
    width: 4px;
    height: 100%;
    background: linear-gradient(180deg, #ff0000, #9c27b0);
    opacity: 0;
...
<div class="section-container">
    <div class="description-section">
        <h2 class="section-title">Artikel {BRAND}</h2>
        <div class="description-content">
            <h3><strong>Daftar 10 Situs Slot Gacor 2026 di {BRAND}</strong></h3>
            <p>Situs slot gacor <a href="{CANONICAL}"><strong>{BRAND}</strong></a> merupakan info daftar 10 link slot gacor hari ini jackpot terbesar 2026 setiap hari & situs judi slot online gampang menang maxwin.</p>
            <p>Melalui pembaruan rutin, {BRAND} membantu pemain menemukan link <a href="{CANONICAL}"><strong>slot gacor</strong></a> hari ini dengan akses cepat, stabil, dan aman untuk pengalaman bermain yang lebih nyaman.</p>

            <h3><strong>Link Slot Gacor Hari Ini untuk Jackpot Terbesar</strong></h3>
            <p>Setiap rekomendasi di {BRAND} dirancang untuk memudahkan pemain memilih situs judi <a href="{CANONICAL}"><strong>slot online</strong></a> yang aktif memberikan jackpot terbesar. Kombinasi RTP kompetitif, pilihan game lengkap, dan metode transaksi praktis menjadi nilai utama.</p>
            <p>Dengan navigasi yang sederhana, pemain pemula maupun berpengalaman bisa lebih cepat masuk ke permainan <a href="{CANONICAL}"><strong>slot</strong></a> online gampang menang maxwin tanpa proses yang rumit.</p>

            <h3><strong>Slot Gacor {BRAND}: Aman, Cepat, dan Terpercaya</strong></h3>
            <p>Selain menampilkan daftar <a href="{CANONICAL}"><strong>situs slot gacor</strong></a>, {BRAND} juga mengutamakan keamanan akses, performa website, dan kenyamanan pengguna saat bermain. Hal ini penting agar pemain bisa fokus berburu peluang kemenangan harian.</p>
            <p>Dengan dukungan update konten yang konsisten, {BRAND} tetap relevan sebagai pilihan utama pencarian keyword slot gacor, slot gacor 2026, hingga rekomendasi situs maxwin terpercaya.</p>
    ...
    <div class="reviews-section">
        <h2 class="section-title">Ulasan Pengguna {BRAND}</h2>
        <div class="reviews-grid">
            <div class="review-card">
                <div class="reviewer-name">Rizky Pratama</div>
                <div class="review-text">Saya suka karena daftar 10 situs slot gacor 2026 di {BRAND} selalu di-update. Lebih mudah cari game potensial jackpot setiap hari.</div>
            </div>
            
            <div class="review-card">
                <div class="reviewer-name">Dimas Saputra</div>
                <div class="review-text">Link slot gacor hari ini yang ditampilkan {BRAND} cepat diakses dan stabil. Sangat membantu saat ingin main tanpa banyak kendala.</div>
            </div>
            
            <div class="review-card">
                <div class="reviewer-name">Bagas Ramadhan</div>
                <div class="review-text">Sebagai pemula, saya terbantu dengan rekomendasi situs judi slot online di {BRAND}. Tampilannya sederhana dan mudah dipahami.</div>
            </div>
            
            <div class="review-card">
                <div class="reviewer-name">Fajar Nugroho</div>
                <div class="review-text">Peluang maxwin terasa lebih bagus karena info slot gacor dan jam main ramai dijelaskan cukup jelas di {BRAND}.</div>
            </div>
            <div class="review-card">
                <div class="reviewer-name">Andika Putra</div>
                <div class="review-text">Platform ini cepat dan responsif. Saya bisa langsung pilih game favorit dari daftar slot gacor tanpa ribet.</div>
            </div>
            <div class="review-card">
                <div class="reviewer-name">Ardiansyah</div>
                <div class="review-text">Untuk cari slot gacor 2026 yang update harian, {BRAND} menurut saya salah satu yang paling konsisten dan terpercaya.</div>
            </div>
        </div>
    </div>

    <div class="faq-section">
    <h2 class="section-title">FAQ {BRAND}</h2>
    <div class="faq-container">
        <div class="faq-item">
            <div class="faq-question">Apa itu {BRAND} slot gacor?</div>
            <div class="faq-answer">
                <p>{BRAND} slot gacor adalah platform informasi dan akses permainan yang membahas daftar situs slot gacor, link harian, serta peluang jackpot terbesar 2026.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Apa keunggulan {BRAND} dibanding platform lain?</div>
            <div class="faq-answer">
                <p>Keunggulannya ada pada update slot gacor hari ini, rekomendasi situs judi slot online gampang menang, serta akses website yang cepat dan stabil.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Apakah {BRAND} aman digunakan untuk bermain?</div>
            <div class="faq-answer">
                <p>Ya, {BRAND} mengutamakan keamanan akses dan kenyamanan pengguna agar aktivitas bermain slot online dapat berlangsung lebih aman.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Apakah {BRAND} cocok untuk pemain pemula?</div>
            <div class="faq-answer">
                <p>Cocok. Panduan dan rekomendasi slot di {BRAND} disusun dengan bahasa sederhana sehingga pemula bisa langsung memahami alur bermain.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Bagaimana cara mengakses link slot {BRAND} hari ini?</div>
            <div class="faq-answer">
                <p>Cukup gunakan link resmi {BRAND} yang aktif hari ini, lalu masuk ke halaman utama untuk memilih situs slot gacor sesuai preferensi Anda.</p>
            </div>
        </div>
    </div>
</div>
         ...
         <div class='cqd-banner__container'>
          <div class="tp-text-note cqd-banner__banner tp-text-note--information tp-text-note--on-light">
           ...
           <div class='tp-text-note__body'>
            <p class='tp-text-note__text'> Nikmati <span class="strong">Bonus Deposit 5%</span> Bagi Pemain Setia <span class="strong">{BRAND}!</p>
           </div>
          </div>
       ...
       <div class='m-design__ratings'>
        <h3 class='m-design__ratings-heading'>MARKET SITUS {BRAND}</h3>
        <div class='m-design__ratings-services'>
         ...
         <div class='m-design__ratings-service'>
          <div class='m-design__ratings-service-name'>SITUS {BRAND}</div>
          <div class='m-design__ratings-service-stars'>
           <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
            <img src="https://assets.teepublic.com/assets/teepublicons/star_warning400-140c727473c9c31e0f5d9ffc791a31dc3ba8dfccc44380702fd86fd805ef817d.svg" loading="lazy" height="20" width="20" aria_hidden="true" focusable="false">
           </span>
        ...
        <div class='contain contain--wide-3'>
         <div class='m-design-product-info-and-faqs'>
          <div class='m-design-product-info--product-quality'>
           <h4>{BRAND} # Daftar Referensi Situs PG Soft Game Online Terbaik Resmi Hari Ini</h4>
           <p>{BRAND} merupakan salah satu situs referensi terbaik untuk anda yang ingin bermain provider Pragmatic Play resmi 2026 untuk memenuhi kebutuhan para pemain slot online dengan ramah setiap hari.</p>
           <picture class='m-design-product-info--product-quality-image'>
            <source srcset='{LOGO_BRAND}' type='image/avif'>
            <source srcset='{LOGO_BRAND}' type='image/webp'>
            <img loading="lazy" src="{LOGO_BRAND}" />
           </picture>
          </div>
         </div>
         <style>
          ...
          <div class='contain contain--wide-3'>
           ...
           <div class='jsSocial'>
            <ul class='m-social-share'>
             <li>
              <a aria-label="Share to Twitter" onclick="window.open(this.href,&#39;pagename&#39;,&#39;resizable,height=400,width=600&#39;); return false" href="{CANONICAL}" class="link jsTwitterProductShare gtmTwitterProductShare twitter link--1 link--default">
               <span class='link__content'>
             ...
             <li>
              <a aria-label="Share to Facebook" onclick="window.open(this.href,&#39;pagename&#39;,&#39;resizable,height=400,width=600&#39;); return false" href="{CANONICAL}" class="link gtmFbProductShare facebook link--1 link--default">
               <span class='link__content'>
                <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent teepublicon-variant--circle medium">
             ...
             <li>
              <a aria-label="Share to Linktree" target="_blank" href="{CANONICAL}" class="link gtmLinktreeProductShare linktree link--1 link--default">
               <span class='link__content'>
                <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent teepublicon-variant--circle medium">
             ...
             <li>
              <a aria-label="Save to Pinterest" onclick="window.open(this.href,&#39;pagename&#39;,&#39;resizable,height=400,width=600&#39;); return false" href="{CANONICAL}" class="link jsPinterestProductShare gtmPinterestProductShare pinterest link--1 link--default">
               <span class='link__content'>
                <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent teepublicon-variant--circle medium">
             ...
             <li>
              <a aria-label="Share to Reddit" target="_blank" href="{CANONICAL}" class="link gtmRedditProductShare reddit link--1 link--default">
               <span class='link__content'>
                <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent teepublicon-variant--circle medium">
             ...
             <li>
              <a aria-label="Share to Tumblr" target="_blank" href="{CANONICAL}" class="link jsTumblrProductShare gtmTumblrProductShare tumblr link--1 link--default">
               <span class='link__content'>
                <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent teepublicon-variant--circle medium">
          ...
          <div class='m-footer-sitemap-container wrapper'>
           <div class='m-footer__trusted-badges'>
            <figure class='m-footer__guarantee-image'>
             <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
              <img src="{LOGO_BRAND}" alt="SITUS {BRAND}" style="width:50%; height:auto; max-width:500px; display:block; margin:0 auto;" />
             </span>
            </figure>
            <div class='m-footer__trusted-text'>
             ...
             <p class='m-footer__guarantee-link'>
              <a target="_blank" href="{CANONICAL}" class="link link__cta link__cta--on-dark link--default">
               <span class='link__content'> SITUS {BRAND} </span>
              </a>
             </p>
            </div>
           ...
           <div class='m-footer-links m-footer-section'>
            <div class="link-collection m-foot__links-section">
             <div class="link-collection__body">
              ...
              <div class="link-collection__content">
               ...
               <a data-gtm-footer-link-text="Coupon Codes" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Coupon Codes </span>
               </a>
               <a data-gtm-footer-link-text="FAQ" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> FAQ </span>
               </a>
               <a data-gtm-footer-link-text="Free Shipping" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Free Shipping </span>
               </a>
               <a data-gtm-footer-link-text="Refunds &amp; Returns" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
            ...
            <div class="link-collection m-foot__links-section">
             <div class="link-collection__body">
              ...
              <div class="link-collection__content">
               ...
               <a data-gtm-footer-link-text="Accessibility" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Accessibility </span>
               </a>
               <a data-gtm-footer-link-text="Create a Dashery Store" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Create a Dashery Store </span>
               </a>
               <a data-gtm-footer-link-text="Careers" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Careers </span>
               </a>
               <a data-gtm-footer-link-text="Hire an Artist" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Hire an Artist </span>
               </a>
               <a data-gtm-footer-link-text="Social Responsibility" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Social Responsibility </span>
               </a>
               <a data-gtm-footer-link-text="TeePublic Reviews" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
            ...
            <div class="link-collection m-foot__links-section">
             <div class="link-collection__body">
              ...
              <div class="link-collection__content">
               <a data-gtm-footer-link-text="All Designs" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> All Designs </span>
               </a>
               <a data-gtm-footer-link-text="Content Directory" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Content Directory </span>
               </a>
               <a data-gtm-footer-link-text="Featured Designers" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Featured Artists </span>
               </a>
               <a data-gtm-footer-link-text="Newest Designers" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Newest Designers </span>
               </a>
               <a data-gtm-footer-link-text="Newest SITUS {BRAND}" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
                <span class='link__content'> Newest SITUS {BRAND} </span>
               </a>
               <a data-gtm-footer-link-text="Tag Directory" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
            ...
            <div class="link-collection m-foot__links-section">
             <div class="link-collection__body">
              ...
              <div class="link-collection__content">
               <a data-gtm-footer-link-text="Create" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
               ...
               <a data-gtm-footer-link-text="TeePublic Blog" style="--animation-order: " href="{CANONICAL}" class="link gtmFooterLink link-collection__link link--1 link--default">
           ...
           <div class='drawer__content-container jsDrawerContentContainer'>
            ...
            <div class='m-tray-cart__body m-tray-cart__body--empty'>
             ...
             <div class='m-tray-cart__body-links'>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="animals" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="anime" data-href="/SITUS {BRAND}/anime" href="/SITUS {BRAND}/anime" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="drinks" data-href="/SITUS {BRAND}/drinks" href="/SITUS {BRAND}/drinks" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="fantasy" data-href="/SITUS {BRAND}/fantasy" href="/SITUS {BRAND}/fantasy" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="food" data-href="/SITUS {BRAND}/food" href="/SITUS {BRAND}/food" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="funny" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="movies" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="sci-fi" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="sports" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="television" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="vintage" data-href="{CANONICAL}" href="{CANONICAL}" class="link vc-pill vc-pill--on-light link--default link--strong tp-btn--icon">
               <span class="teepublicon teepublicon--blue-default teepublicon-background--transparent">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 48 48" width="16" height="16" focusable="false" aria-hidden="true">
                 <path fill-rule="evenodd" d="M31.523 35.766a17.393 17.393 0 0 1-10.051 3.178C11.822 38.944 4 31.121 4 21.472 4 11.822 11.822 4 21.472 4c9.65 0 17.472 7.822 17.472 17.472 0 3.741-1.176 7.208-3.178 10.05l7.355 7.356a3 3 0 1 1-4.243 4.243l-7.355-7.355Zm1.42-14.294c0 6.335-5.136 11.471-11.471 11.471s-11.471-5.136-11.471-11.471 5.136-11.471 11.471-11.471 11.471 5.136 11.471 11.471Z" clip-rule="evenodd"></path>
                </svg>
             ...
             <div class='m-tray-shop-secondary__content'>
              ...
              <div class="link-collection m-tray-shop-secondary__links">
               <div class="link-collection__body">
                ...
                <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="New Tees on Sale" data-href="/SITUS {BRAND}?sort=newest" style="--animation-order: " href="/SITUS {BRAND}?sort=newest" class="link m-tray-shop-secondary__link link-collection__link link--1 link--default">
           ...
           <div class='m-tray-shop-secondary__body'>
            <div class='m-tray-shop-secondary__content'>
             ...
             <div class='m-tray-shop-secondary__links'>
              <a class="m-tray-shop-secondary__link" data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="SITUS {BRAND}" data-href="/SITUS {BRAND}" href="/SITUS {BRAND}">
               <h4 class="h--no-s">SITUS {BRAND}</h4>
              </a>
              ...
              <a class="m-tray-shop-secondary__link" data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Long Sleeve SITUS {BRAND}" data-href="/long-sleeve-SITUS {BRAND}" href="/long-sleeve-SITUS {BRAND}">
               <h4 class="h--no-s">Long Sleeve SITUS {BRAND}</h4>
              </a>
              ...
              <a class="m-tray-shop-secondary__link" data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Baseball SITUS {BRAND}" data-href="/baseball-SITUS {BRAND}" href="/baseball-SITUS {BRAND}">
               <h4 class="h--no-s">Baseball SITUS {BRAND}</h4>
              </a>
             </div>
            </div>
            <div class='m-tray-shop-secondary__content'>
             <h3>Kids Apparel</h3>
             <div class='m-tray-shop-secondary__links'>
              <a class="m-tray-shop-secondary__link" data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Kids SITUS {BRAND}" data-href="/kids-SITUS {BRAND}" href="/kids-SITUS {BRAND}">
               <h4 class="h--no-s">Kids SITUS {BRAND}</h4>
              </a>
              ...
              <a class="m-tray-shop-secondary__link" data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Kids Long Sleeve SITUS {BRAND}" data-href="/kids-long-sleeve-SITUS {BRAND}" href="/kids-long-sleeve-SITUS {BRAND}">
               <h4 class="h--no-s">Kids Long Sleeve SITUS {BRAND}</h4>
              </a>
             </div>
            </div>
           </div>
           ...
           <div class='m-tray-shop__body'>
            <div class='m-tray-shop__logo-container'>
             <div class="vc-header-logo">
              <a aria-label="Home Link" title="Home" href="https://www.teepublic.com/" class="link vc-header-logo__wrapper link--1 link--default">
               <span class='link__content'>
                <picture>
                 <source srcset="{LOGO_BRAND}" type="image/png">
                 <img class="vc-header-logo__image" src="{LOGO_BRAND}" style="max-width:150px; height:auto; display:block; margin:0 auto;" alt="SITUS {BRAND} Logo">
                </picture>
               </span>
              </a>
              <div class='vc-header-logo__content'></div>
            ...
            <div class="m-tray-shop__popular-products">
             ...
             <div class='m-tray-shop__popular-products-grid'>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="SITUS {BRAND}" data-href="/SITUS {BRAND}" href="/SITUS {BRAND}" class="link m-tray-shop__popular-product tshirt">
               <span class='link__content'>
                <span>SITUS {BRAND}</span>
               </span>
              </a>
              ...
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="Kids SITUS {BRAND}" data-href="/kids-SITUS {BRAND}" href="/kids-SITUS {BRAND}" class="link m-tray-shop__popular-product kids">
               <span class='link__content'>
                <span>Kids SITUS {BRAND}</span>
               </span>
              </a>
            ...
            <div class="m-tray-shop__popular-topics">
             ...
             <div class='m-tray-shop__popular-topics-content'>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="funny" data-href="{CANONICAL}" title="Funny" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> funny </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="music" data-href="{CANONICAL}" title="Music" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> music </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="anime" data-href="{CANONICAL}" title="Anime" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> anime </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="movies" data-href="{CANONICAL}" title="Movies" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> movies </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="television" data-href="{CANONICAL}" title="Television" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> television </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="sports" data-href="{CANONICAL}" title="Sports" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> sports </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="sci-fi" data-href="clerk.youdown.io/img/{BRAND}-youdown.webp" title="Sci-Fi" href="clerk.youdown.io/img/{BRAND}-youdown.webp" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> sci-fi </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="vintage" data-href="{CANONICAL}" title="Vintage" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> vintage </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="animals" data-href="{CANONICAL}" title="Animals" href="{CANONICAL}" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> animals </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="drinks" data-href="/SITUS {BRAND}/drinks" title="Drinks" href="/SITUS {BRAND}/drinks" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> drinks </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="food" data-href="/SITUS {BRAND}/food" title="Food" href="/SITUS {BRAND}/food" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> food </span>
              </a>
              <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="politics" data-href="/SITUS {BRAND}/politics" title="Politics" href="/SITUS {BRAND}/politics" class="link m-tray-shop__popular-topic vc-pill vc-pill--on-dark link--default link--strong">
               <span class='link__content'> politics </span>
              </a>
             </div>
             <a data-rudderstack-event-type="link" data-action="click-&gt;rudderstack--link-clicked#track" data-link-label="All Popular Designs" data-href="/SITUS {BRAND}?sort=popular" href="/SITUS {BRAND}?sort=popular" class="link m-tray-shop__popular-topics-cta link__cta link__cta--on-dark link--default">
         ...
         <div class='custom-modal-content'>
          <div class='m-browse-preferences'>
           ...
           <form action="/browse_preferences/change" accept-charset="UTF-8" method="post">
            ...
            <input value="{&quot;design_slug&quot;:&quot;SITUS {BRAND}&quot;,&quot;controller&quot;:&quot;product_pages&quot;,&quot;action&quot;:&quot;show&quot;,&quot;id&quot;:&quot;74165272-george-kittle-f-dallas-kittle&quot;}" autocomplete="off" type="hidden" name="referring_params" id="referring_params" />
        ...
        TeePublic['ProductOptions'] = {
         ...
         "CanvasOptions": {
          ...
          "descriptions": [
           ...
           ["60% Organic Cotton, 40% Recycled Poly RPET - approximately 4 recycled RPET bottles are used per shirt. A heavier weight than the Classic SITUS {BRAND}, for enhanced comfort and durability. Your favorite SITUS {BRAND}, made better. ", [2954, 2959, 2986, 2981, 2988, 2976, 2956, 2977, 2975, 2978, 2958, 2991, 2992, 2960, 2982, 2989, 2993, 2967, 2971, 2973, 2974, 2980, 2952, 2969, 2984, 2987, 2970, 2972, 2955, 2962, 2957, 2985, 2968, 2953, 2983, 2965, 2979, 2961, 2963, 2990, 2964, 2966]],
          ...
          "tooltips": [{
           ...
           "type": "tee_outline",
           "header": "TEE TIP!",
           "tip": "Many customers prefer to order a size or two up for the Tri-Blend SITUS {BRAND}",
...
<script>
  ...
  gtag('config', 'G-404GXE7LR3');
        ...
        window.addEventListener('load', function() {
         if (window.rudderanalytics && true) {
          window.rudderanalytics.page({
           ...
           "price_usd": 23.0,
           "product_color": "Red",
           "product_description": "Classic SITUS {BRAND}, Male Fit | Small, Red",
           "product_gender": "Male Fit",
           "product_id": 357,
           "product_size": "S",
           "product_style": "Classic SITUS {BRAND}",
           "search_type": "default"
          });
         }
        });
       ...
       <style>
            ...
            /* FLOAT DELAY */
            .footer-btn-{BRAND}.login {
                animation-delay: 0.3s;
            }
            .footer-btn-{BRAND}.daftar {
                animation-delay: 0.6s;
            }
            .footer-btn-{BRAND}.link {
                animation-delay: 0.9s;
            }
            .footer-btn-{BRAND}.chat {
        ...
        <div class="footer-floating-{BRAND}">
        <a href="{AMP}" class="footer-btn-{BRAND} promo" target="_blank"
                    rel="nofollow noopener">
                    <img src="{FAVICON}" alt="PROMOSI"> PROMO
                </a>

        <a href="{AMP}" class="footer-btn-{BRAND}" target="_blank"
                    rel="nofollow noopener">
                    <img src="{FAVICON}" alt="Login"> LOGIN
                </a>

        <a href="{AMP}" class="footer-btn-{BRAND} daftar" target="_blank"
                    rel="nofollow noopener">
                    <img src="{FAVICON}" alt="Daftar"> DAFTAR
                </a>

        <a href="{AMP}" class="footer-btn-{BRAND} link" target="_blank"
                    rel="nofollow noopener">
                    <img src="{FAVICON}" alt="Link Alternatif"> LINK ALTERNATIF
                </a>

        <a href="{AMP}" class="footer-btn-{BRAND} chat" target="_blank"
                    rel="nofollow noopener">
                    <img src="{FAVICON}" alt="Live Chat"> LIVE CHAT
                </a>
        </div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"36ee0680a2a24fba961ee174c15df804","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"765271465aab420195169a59f675a396","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8c78df7c7c0f484497ecbca7046644da1771523124516" integrity="sha512-8DS7rgIrAmghBFwoOTujcf6D9rXvH8xm8JQ1Ja01h9QX8EzXldiszufYa4IFfKdLUKTTrnSFXLDkUEOTrZQ8Qg==" data-cf-beacon='{"version":"2024.11.0","token":"32eb1dc123784d80ab2821aac415ebe9","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"9ed175494c5cf87a","version":"2025.9.1","r":1,"serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"bf64e3ffbc7545fd9e8e2d60e35707a4","b":1}' crossorigin="anonymous"></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v833ccba57c9e4d2798f2e76cebdd09a11778172276447" integrity="sha512-57MDmcccJXYtNnH+ZiBwzC4jb2rvgVCEokYN+L/nLlmO8rfYT/gIpW2A569iJ/3b+0UEasghjuZH/ma3wIs/EQ==" data-cf-beacon='{"version":"2024.11.0","token":"18f620ba2c3a40119660c33525c58816","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>
</html>