...
<div class="shell">
  ...
  <div class="marquee-wrapper">
    <div class="marquee-text">
      Selamat Datang Pak Bos, Menang Menang Terus Pak Bos
    </div>
  </div>
  ...
  <section class="card hero">
    ...
    <div class="cta">
      <a class="btn" href="{MONEY_SITE}" target="_blank">LOGIN</a>
      <a class="btn" href="{MONEY_SITE}" target="_blank">DAFTAR</a>
    </div>


    <div class="section-buttons">
      <div class="badge-container">
        <span class="badge">AKSES RESMI</span>
        <span class="badge">LINK ALTERNATIF</span>
        <span class="badge">PUSAT BANTUAN</span>
      </div>

      <div class="badge-container">
        <span class="badge">DAFTAR AKUN</span>
        <span class="badge">LOGIN MEMBER</span>
        <span class="badge">INFO SITUS</span>
        <span class="badge"><a href="{MONEY_SITE}" style="color:white;">LINK AKSES GACOR</a></span>
      </div>
    </div>
